<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="sidebar" style="">
        <div class="top">
            <div class="logo">
                <a href="dashboard" class="logo">Sepilok Rehabilitation Centre</a>
            </div>
            <div class="logo2">
    @auth
        <ul>
            ...
            @else
                ...
                <li>
                    <a href="bookTourist" class="work"></i>Booking</a>
                </li>
                <li>
                    <a href="contact" class="Contact"></i>Contact</a>
                </li>
            @endif
        </ul>
    @endauth
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6" style="justify-content: right; display: flex;">
